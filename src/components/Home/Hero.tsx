		...
		<section className="min-h-screen relative">
			<div className="container flex flex-col xl:flex-row gap-20 items-center justify-between pt-28 h-full">
				...
				<div className="flex flex-col gap-5 sm:gap-0 left max-w-[500px] xl:max-w-[718px] dark:text-white text-black">
					...
					<h1 className="font-bold tracking-[0.03em] text-5xl sm:text-[70px] xl:text-[100px] text-nowrap flex flex-col w-full sm:leading-[6.5rem]">
						<span>UI & UX</span>
					...
					<Link to={"#"} className="sm:self-start self-center px-[52px] py-3 bg-primary hover:bg-primary/80 transition-colors duration-300 ease-in-out rounded-md mt-3 inline-block">
						Hire Me
					</Link>
				</div>
